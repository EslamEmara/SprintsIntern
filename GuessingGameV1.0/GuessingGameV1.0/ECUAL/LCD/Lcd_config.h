...
#define LCD_RS			PORTC,PIN1
#define LCD_RW			PORTC,PIN2
#define LCD_EN			PORTC,PIN3

#if LCD_MODE == FOUR_BIT_MODE

	#define LCD_D4			PORTC,PIN4
	#define LCD_D5			PORTC,PIN5
	#define LCD_D6			PORTC,PIN6
	#define LCD_D7			PORTC,PIN7
#else 
